...
There's also no way to add keys to the web nodes at runtime AND have them recognise the new key.  This means if you need to add worker keys at runtime, you need to recycle ALL of your web nodes.
